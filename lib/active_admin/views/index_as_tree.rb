  ...
  module Views
    class IndexAsTree < ActiveAdmin::Component
      ...
      def build_childs_table(categorizer_current_id)
        ...
        input name: :categorizer_current_id, type: :hidden, value: params[:categorizer_current_id] if params[:categorizer_current_id]
        input name: :menu, type: :hidden, value: params[:menu] if params[:menu]
