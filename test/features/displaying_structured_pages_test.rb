...
feature 'Displaying structured pages content of the site' do
  ...
  scenario 'display page title in browser title' do
    create :root_page, title: 'Company Information', slug: 'company-information', permalink: 'company-information'
  ...
  scenario 'display page title in browser title for nested page' do
    root_section = create :root_page, slug: 'company-information', permalink: 'company-information'
    create :root_page, title: 'About Us', parent: root_section, slug: 'about', permalink: 'company-information/about'
  ...
  scenario 'display content of root basic section' do
    ...
    create :root_page, content: content, slug: 'company-information', permalink: 'company-information'
  ...
  scenario 'display content of child basic section' do
    ...
    root_section = create :root_page, slug: 'Car Catalog', permalink: 'car-catalog'
    create :page, parent: root_section, content: content, slug: 'Sports Cars', permalink: 'car-catalog/sports-cars'
  ...
  scenario 'display content of root basic page' do
    ...
    create :root_page, content: content, slug: 'about', permalink: 'about'
  ...
  scenario 'display content of nested in section basic page' do
    content = create :basic_page, title: 'About Us', body: 'Work in progress'
    root_section = create :root_page, slug: 'Information', permalink: 'information'
    create :page, parent: root_section, content: content, slug: 'Sports Cars', permalink: 'information/about'
